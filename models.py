...
class FlowWorld(ModelMixin, ConfigMixin):
...
def FlowWorld_XL_2(**kwargs):
    return FlowWorld(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)

FlowWorld_models = {
    'FlowWorld-XL/2': FlowWorld_XL_2
}

FlowWorld_models_class = {
    'FlowWorld-XL/2': FlowWorld
}