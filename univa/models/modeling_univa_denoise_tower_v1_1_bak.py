...
class UnivaDenoiseTower_V1_1(UnivaDenoiseTower):
    ...
    def __init__(self, config: UnivaDenoiseTowerConfig):
        ...
        self.aspect_ratio_embedder = PixArtAlphaAspectEmbeddings(4096)
    ...
    def _init_siglip_projector(self):
        self.siglip_projector = nn.Sequential(
            # Rearrange('b (h2 h) (w2 w) c -> b (h w) (c h2 w2)', h2=2, w2=2),
            nn.Linear(
            ...
            nn.Linear(
                4096 * 4,  # HARDCODE, pixunshuffle dim
                4096,  # HARDCODE, reduce dim
            ),
            ZeroResBlock(4096), 
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        aspect_ratio_embed = self.aspect_ratio_embedder(aspect_ratio, encoder_hidden_states.dtype)
        encoder_hidden_states = torch.concat([encoder_hidden_states, aspect_ratio_embed], dim=1)
