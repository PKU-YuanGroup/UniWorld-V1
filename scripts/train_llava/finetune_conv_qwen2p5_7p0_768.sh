...
PRETRAIN_DIR="/storage/lb/logs/ross/llava-conv-qwen2p5-7p0b-pt558k-newenv-768"
OUTPUT_DIR="/storage/lb/logs/ross/llava-conv-qwen2p5-7p0b-pt558k-sft737k-newenv-768"
