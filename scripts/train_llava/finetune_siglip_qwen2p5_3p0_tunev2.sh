...
PRETRAIN_DIR="/storage/lb/logs/ross/llava-siglip-qwen2p5-3p0b-pt558k-newenv"
OUTPUT_DIR="/storage/lb/logs/ross/llava-siglip-qwen2p5-3p0b-pt558k-sft737k-newenv-tunev2"
