...
PRETRAIN_DIR="/storage/lb/logs/ross/llava-conv-qwen2p5-3p0b-pt558k-newenv-320"
OUTPUT_DIR="/storage/lb/logs/ross/llava-conv-qwen2p5-3p0b-pt558k-sft737k-newenv-320"
