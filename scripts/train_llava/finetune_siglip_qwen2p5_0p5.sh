...
PRETRAIN_DIR="/storage/lb/logs/ross/llava-siglip-qwen2p5-0p5b-pt558k-newenv"
OUTPUT_DIR="/storage/lb/logs/ross/llava-siglip-qwen2p5-0p5b-pt558k-sft737k-newenv"
