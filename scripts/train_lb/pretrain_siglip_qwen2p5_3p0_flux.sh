...
DENOISE_DECODER="/mnt/data/checkpoints/black-forest-labs/FLUX.1-dev/"
PRETRAIN_DIR="/mnt/data/lb/logs/univa/univa-siglip-qwen2p5-3p0b-pt558k-sft737k-mmtag-0403"
OUTPUT_DIR="/mnt/data/lzj/logs/univa/univa-siglip-qwen2p5-3p0b-pt558k-sft737k-mmtag-0403-stage3-pt"
RUN_NAME="univa-siglip-qwen2p5-3p0b-pt558k-sft737k-mmtag-0403-stage3-pt"

mkdir -p ${OUTPUT_DIR}

torchrun --nproc-per-node=8 --nnodes 1 --standalone \
