...
PRETRAIN_DIR="/storage/lb/logs/ross/ross-siglip-vicuna-7b-pt558k"
OUTPUT_DIR="/storage/lb/logs/ross/ross-siglip-vicuna-7b-pt558k-sft737k"
RUN_NAME="ross-siglip-vicuna-7b-pt558k-sft737k"
